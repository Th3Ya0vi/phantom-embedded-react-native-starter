...
- Embedded user wallet experience without a browser extension
- SOL balance display with manual refresh
- Copy-to-clipboard address management
- Disconnect flow with clean session handling
- Mobile-first design for iOS and Android
- Light theme UI aligned with Phantom branding
